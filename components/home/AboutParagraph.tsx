...
const AboutParagraph = () => {
  ...
  useEffect(() => {
    ...
    const observer = new ResizeObserver(([entry]) => { setTextHeight(entry.contentRect.height); });
        ...
        <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-16">
          ...
          >
            <svg viewBox="0 0 280 400" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ height: "100%", width: "auto" }}>
              ...
              <motion.g animate={{ y: [0, -6, 0], opacity: [0.5, 1, 0.5] }} transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}>
                <circle cx="55" cy="180" r="3" fill="#7C9A72" opacity="0.6" />
                <circle cx="48" cy="195" r="2" fill="#7C9A72" opacity="0.4" />
              </motion.g>
              <motion.g animate={{ y: [0, -8, 0], opacity: [0.4, 1, 0.4] }} transition={{ duration: 3.5, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}>
                <circle cx="228" cy="175" r="3" fill="hsl(18 78% 57%)" opacity="0.6" />
                <circle cx="235" cy="192" r="2" fill="hsl(18 78% 57%)" opacity="0.4" />
              </motion.g>
              <motion.g animate={{ y: [0, -5, 0], rotate: [0, 10, 0] }} transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 1 }}>
                <path d="M222 155L226 148L230 155L226 152Z" fill="hsl(44 88% 57%)" opacity="0.5" />
              </motion.g>
              <motion.g animate={{ y: [0, -6, 0], rotate: [0, -8, 0] }} transition={{ duration: 3.8, repeat: Infinity, ease: "easeInOut", delay: 0.8 }}>
